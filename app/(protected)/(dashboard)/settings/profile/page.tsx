...
const MyProfile = () => {
  ...
  return (
    <div className="flex flex-col gap-6 mt-6">
      <div className="rounded-md border-[1px] p-4 md:p-8 border-[#B5D2CC] border-solid">
        <div className="md:flex gap-8 md:items-center">
          ...
          <div className={`${raleway.className} mt-3`}>
            <p className="text-auth-text-color font-semibold text-lg">
              Alfred Wanjau
            </p>
      ...
      <div
        className={`rounded-md border-[1px] p-4 md:p-8 border-[#B5D2CC] border-solid ${raleway.className}`}
      >
        <Form {...form}>
          <form
            onSubmit={form.handleSubmit(handleSave)}
            className="space-y-8 md:flex md:justify-between"
          >
            <div className="md:w-[70%]">
              <p className="text-auth-text-color font-semibold text-[20px] mb-3">
              ...
              <div className="md:grid md:grid-cols-2 gap-8">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-[#949494] font-semibold text-sm">
                        First Name
                      </FormLabel>
                      {isEditing ? (
                        <FormControl>
                        ...
                        <p className="text-auth-text-color text-base font-semibold">
            ...
            {isEditing ? (
              <div className="md:relative top-10">
                ...
                <Button
                  ...
                  className="bg-[#004A39] text-[#BBFB00]"
                >
                  Cancel
                </Button>
              </div>
      ...
      >
        <Form {...formAddress}>
          <form
            onSubmit={formAddress.handleSubmit(handleSaveAddress)}
            className="space-y-8 md:flex md:justify-between"
          >
            <div className="md:w-[70%]">
              <p className="text-auth-text-color font-semibold text-xl mb-3">
                Address
              </p>
              <div className="md:grid md:grid-cols-2 gap-8">
                <FormField
